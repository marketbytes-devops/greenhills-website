...
const Gather = () => {
  ...
  // SEO data for Gather pages
  const seoData = [
    {
      id: 1,
      title: "Events",
      link: "events-hotel-green-hills-valparai",
      seoTitle: "Events and Family Gatherings | Hotel Green Hills Valparai",
      description:
        "Celebrate your special occasion at Hotel Green Hills Valparai ideal venue for weddings, Family Gathering, retreats with scenic mountain views.",
      keyword: "Best hotel event space in Valparai",
      canonical: "https://www.hotelgreenhills.in/gather/events-hotel-green-hills-valparai",
    },
    {
      id: 2,
      title: "Business Gatherings",
      link: "business-gatherings-valparai",
      seoTitle: "Business Gatherings and Meetings | Green Hills Valparai",
      description:
        "Host your business meetings and corporate events at Hotel Green Hills, Valparai, professional facilities, scenic environment and customizable catering.",
      keyword: "Best Business event venue in Valparai",
      canonical: "https://www.hotelgreenhills.in/gather/business-gatherings-valparai",
    },
  ];
  ...
  return (
    <>
      {/* Add Helmet for SEO */}
      <Helmet>
        <title>{currentSeo.seoTitle || "Gather at Hotel Green Hills Valparai"}</title>
        <meta
          name="description"
          content={currentSeo.description || "Host your events at Hotel Green Hills, Valparai."}
        />
        <meta
          name="keywords"
          content={currentSeo.keyword || "Hotel Green Hills, Valparai, events"}
        />
        <link
          rel="canonical"
          href={currentSeo.canonical || "https://www.hotelgreenhills.in/gather"}
        />
      </Helmet>
